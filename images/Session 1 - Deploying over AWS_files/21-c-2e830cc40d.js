(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[21],{BdLV:function(e,t,i){"use strict"
i.r(t)
...
return new S(e)}function P(e,t){let i=e.replace(/(auto_open|inline_disabled)/g,"")
...
Object(z["b"])("BookmarkService",(function(e){const t=r.data("editor")
...
Object(z["a"])(o()(this).data("service").service,e=>{o()("#instructure_link_prompt").dialog("close")
...
r.dialog({width:425,height:"auto",title:"Link to Website URL",open(){o()(this).find(".prompt").focus().select()}})}function V(e,t){V.counter=V.counter||0
true==t&&0!=V.counter?V.counter=(V.counter+1)%5:o()(e.getBody()).find("a").each((function(){const e=new A
const t=o()(this)
...
t.text()===t.attr("href")&&i<1&&e.titleYouTubeText(t)}}))}function O(e){if(B.get(e)||void 0===e.on)return
...
o()(this).remove()}))}))
e.on("change",()=>{V(e)})
e.on("SetContent",()=>{V(e,"contentJustSet")})
B.set(e,true)}var I={buttonToImg:L,prepEditorForDialog:R,buildLinkClasses:P,bindLinkSubmit:N,renderDialog:D,updateLinks:V,initEditor:O}
i("q1tI")
var q=i("i8i4")
var M=i.n(q)
const H={get more_external_tools(){return Object(y["a"])(v.t("more_external_tools","More External Tools"))}}
const G={init(e,t,r){I.initEditor(e)
if(!r||!r.editorButtons||!r.editorButtons.length)return
let n={open:(...e)=>setTimeout(()=>n.open(...e),50)}
Promise.all([i.e(1),i.e(2),i.e(3),i.e(5),i.e(6),i.e(9),i.e(19),i.e(627)]).then(i.bind(null,"PrO8")).then(({default:t})=>{const i=document.createElement("div")
...
document.addEventListener("tinyRCE/initEquation",({detail:t})=>{Promise.all([i.e(10),i.e(668)]).then(i.bind(null,"dIBj")).then(({default:i})=>{const r=new i(t.ed)
e.equationCB(r)})})
document.addEventListener("tinyRCE/initLinks",({detail:t})=>{I.renderDialog(t.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",t=>{Promise.all([i.e(1),i.e(2),i.e(7),i.e(10),i.e(11),i.e(12),i.e(23),i.e(79),i.e(85),i.e(111),i.e(631)]).then(i.bind(null,"FfTR")).then(({default:i})=>{const r=new i(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(r)})})
document.addEventListener("tinyRCE/initEquella",t=>{i.e(700).then(i.bind(null,"IOhY")).then(({default:i})=>{i(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",t=>{Q.init(t.detail.ed,t.detail.url,g["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",t=>{Promise.all([i.e(42),i.e(701)]).then(i.bind(null,"lUrZ")).then(({default:i})=>{i.insertEditor(t.detail.ed)
...
if(!s||"account"===i){r=a
i="user"}return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,containingContext:o,contextType:i,contextId:r,filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:d(ENV.JWT),themeUrl:ENV.active_brand_config_json_url}}let se
...
const i=oe()
this.loadRCE(r=>{r.renderSidebarIntoDiv(e,i,e=>{t(re.wrapSidebar(e))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){se||(se=(window.ENV.use_rce_enhancements?Promise.all([i.e(1),i.e(2),i.e(3),i.e(5),i.e(6),i.e(7),i.e(8),i.e(12),i.e(14),i.e(15),i.e(22),i.e(24),i.e(30),i.e(40),i.e(44),i.e(82),i.e(83),i.e(86),i.e(90),i.e(81),i.e(94),i.e(95),i.e(120),i.e(156),i.e(158),i.e(307)]).then(i.bind(null,"EDBv")):Promise.all([i.e(1),i.e(2),i.e(3),i.e(5),i.e(6),i.e(8),i.e(14),i.e(15),i.e(22),i.e(24),i.e(28),i.e(40),i.e(44),i.e(83),i.e(86),i.e(81),i.e(95),i.e(120),i.e(308)]).then(i.bind(null,"dHiD"))).then(e=>{this.RCE=e
X()
return e}))
